...
def init_mod(game):
    ...
    test_screen.add_option("Exit", lambda: game.screen_manager.get_screen_by_identifier("critSystem:test").close())
    # or test_screen.add_option("Exit", lambda: test_screen.close())
